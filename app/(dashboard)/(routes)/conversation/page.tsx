...
const ConversationPage = () => {
    ...
    const onSubmit = async (values:z.infer<typeof formSchema>)=>{
        try {
            ...
            router.refresh(); // this is used to rehidrate all server component fetching the new data from databse thats why the free tier counter progress bar updates automatically after a prompt
        }
    }
